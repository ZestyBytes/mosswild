...
const GameAudio=(()=>{
 ...
 if(prefs.ambient&&pos===0&&!['home','cottage','cavern'].includes(ambientArea)){noise(next,2.8,.05,scene==='water'?1000:450,ambientBus);if(!isNight&&bar%4===1){tone(1460,next+.7,.18,.045,ambientBus);tone(1800,next+.93,.14,.028,ambientBus);}}
